...
class OAuthCog(commands.Cog):
    ...
    async def link(self, interaction: discord.Interaction) -> None:
        ...
        embed.add_field(name="Entry Link", value=self.bot.settings.roblox_entry_link, inline=False)
        embed.add_field(name="Privacy Policy", value=self.bot.settings.roblox_privacy_policy_url, inline=False)
        embed.add_field(name="Terms of Service", value=self.bot.settings.roblox_terms_url, inline=False)
        embed.add_field(name="Redirect URL", value=self.bot.settings.roblox_redirect_uri, inline=False)
